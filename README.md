...
| [`census/mech-probe/`](census/mech-probe) — MECH-PROBE-1, feasibility probe of a non-LLM rule-based classifier (NOT a census; no number joins any series) | 127 | **NEGATIVE — arc closed.** Classifier scores 26.8% on the whole corpus vs a 30.7%/33.1% constant baseline: below chance-of-the-baseline. Coverage 44.1%. Carries a cold-review correction withdrawing its original causal claim | MLS spent by this run; TLS/iCal/QUIC protected. Grader ships with a KAT |
...
9. ~~A NON-protocol corpus~~ — DONE 2026-08-15 (`census/ical/`): RFC
   ...
   REGISTERED (2026-08-16, `census/human/` — frozen sample, packet,
   scorer; awaiting a recruited non-author human, ~90 minutes); the
