...
9. ~~A NON-protocol corpus~~ — DONE 2026-08-15 (`census/ical/`): RFC
   ...
   the discrimination lived in Z7 + rule 23); still open on the v5
   docket: Z2/Z3/Z5 and Z4-overall await first v5 passes on TLS, RFC
   9001, and iCal (each its own deliberate arc), and the v5-quic
